...
export class ToppingCategoriesController {
  constructor(private readonly toppingCategoriesService: ToppingCategoriesService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateToppingCategoryDto: UpdateToppingCategoryDto) {
