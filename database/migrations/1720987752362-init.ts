...
export class Init1720987752362 implements MigrationInterface {
    name = 'Init1720987752362'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "subtotal" double precision NOT NULL, "delivery_fee" double precision NOT NULL, "service_fee" double precision NOT NULL, "total" double precision NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" integer, "address_id" integer, "restaurant_id" integer, "order_status_id" integer, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
