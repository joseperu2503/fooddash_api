...
export class Init1723775985266 implements MigrationInterface {
    name = 'Init1723775985266'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "subtotal" double precision NOT NULL, "delivery_fee" double precision NOT NULL, "service_fee" double precision NOT NULL, "total" double precision NOT NULL, "delivered_date" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" integer, "address_id" integer, "restaurant_id" integer, "order_status_id" integer, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "addresses" ("id" SERIAL NOT NULL, "city" text NOT NULL, "country" text NOT NULL, "address" text NOT NULL, "detail" text NOT NULL, "references" text NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" integer, "address_tag_id" integer, "address_delivery_id" integer, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "carts" ("id" SERIAL NOT NULL, "subtotal" double precision NOT NULL, "delivery_fee" double precision NOT NULL, "service_fee" double precision NOT NULL, "total" double precision NOT NULL, "user_id" integer, "restaurant_id" integer, "address_id" integer, CONSTRAINT "REL_2ec1c94a977b940d85a4f498ae" UNIQUE ("user_id"), CONSTRAINT "PK_b5f695a59f5ebb50af3c8160816" PRIMARY KEY ("id"))`);
